...
WHILE @i < $(count)
	...
	Declare @LineBindingID int = (SELECT MAX([LineID])FROM [GSO].[dbo].[LinesBinding]) 
	...
	INSERT INTO GSO.dbo.SZSShedule(SZSDevID,DevStaffID,DevClassID,BaseType,GlobalType,UserType,ConnParam,PriorType,CurrCall) VALUES(@serNoSZDevice,@StaffID,22,5,0,0,@LineBindingID,1,0)
